  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-100 mb-4">PDF Tools</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {tools.map((tool) => (
          <Card 
            key={tool.id} 
            className={`cursor-pointer transition-all duration-200 ${tool.color} hover:shadow-lg border-2 hover:border-blue-500 bg-gray-800 border-gray-700`}
          ...
          >
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-lg font-semibold text-gray-100">{tool.title}</CardTitle>
              <CardDescription className="text-sm text-gray-400 min-h-[40px]">
                {tool.description}
              </CardDescription>
            </CardHeader>
